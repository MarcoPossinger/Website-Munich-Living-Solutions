    ...
    >
      ...
      <main className="w-full max-w-[440px] relative pt-16 pb-20">
        ...
        >
          ...
          <button
            onClick={handleShare}
            className="absolute top-[8rem] right-8 p-2.5 rounded-full bg-white/[0.04] backdrop-blur-md border border-white/15 hover:bg-white/15 transition-all active:scale-90 z-10"
          >
            <svg
