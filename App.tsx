          ...
          <div className="w-full flex justify-center mb-10 pt-4">
            <div className="relative w-full h-12 flex items-center justify-center">
              ...
              <div
                ...
                style={{
                  background:
                    "linear-gradient(90deg, rgba(184,134,11,0.00) 100%, rgba(184,134,11,0.00) 18%, rgba(184,134,11,0.90) 45%, rgba(184,134,11,0.90) 55%, rgba(184,134,11,0.00) 82%, rgba(184,134,11,0.00) 100%)",
                }}
              />
