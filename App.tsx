          ...
          <div className="w-full flex justify-center mb-10 pt-4">
            <div className="relative w-full h-12 flex items-center justify-center">
              ...
              <div
                ...
                style={{
                  background:
                    "linear-gradient(90deg, rgba(196,140,33,0.00) 0%, rgba(196,140,33,0.07) 5%, rgba(196,140,33,0.16) 10%, rgba(196,140,33,0.3) 15%, rgba(196,140,33,0.40) 20%, rgba(196,140,33,0.50) 25%, rgba(196,140,33,0.65) 30%, rgba(196,140,33,0.80) 35%, rgba(196,140,33,1) 40%, rgba(196,140,33,1) 60%, rgba(196,140,33,0.80) 65%, rgba(196,140,33,0.65) 70%, rgba(196,140,33,0.50) 75%, rgba(196,140,33,0.40) 80%, rgba(196,140,33,0.30) 85%, rgba(196,140,33,0.16) 90%, rgba(196,140,33,0.07) 95%, rgba(196,140,33,0.00) 100%)",
                }}
              />
