    ...
    <div className={`relative min-h-screen bg-[#050505] flex flex-col items-center justify-start p-4 text-white font-serif-custom overflow-y-auto overflow-x-hidden transition-opacity duration-1000 ${isLoaded ? 'opacity-100' : 'opacity-0'}`}>
      ...
      <main className="w-full max-w-[440px] relative pt-16 pb-20">
        ...
        <div className={`relative bg-[#0d0d0d] rounded-[3.5rem] shadow-[0_50px_100px_-20px_rgba(0,0,0,1)] border border-white/[0.06] overflow-hidden flex flex-col items-center p-8 md:p-10 text-center transition-all duration-1000 delay-100 ${isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-12 opacity-0'}`}>
          ...
          <button 
            onClick={handleShare}
            className="absolute top-8 right-8 p-3 rounded-full bg-white/[0.03] border border-white/10 hover:bg-white/10 transition-all active:scale-90 z-10"
          >
          ...
          <div className="w-full flex justify-center mb-10 pt-4">
            <div className="relative w-full h-12 flex items-center justify-center">
              ...
              <div
                ...
                style={{
                  background:
                    "linear-gradient(90deg, rgba(196,140,33,0.00) 0%, rgba(196,140,33,0.07) 5%, rgba(196,140,33,0.16) 10%, rgba(196,140,33,0.3) 15%, rgba(196,140,33,0.44) 20%, rgba(196,140,33,0.58) 25%, rgba(196,140,33,0.72) 30%, rgba(196,140,33,0.86) 35%, rgba(196,140,33,1) 40%, rgba(196,140,33,1) 60%, rgba(196,140,33,0.86) 65%, rgba(196,140,33,0.72) 70%, rgba(196,140,33,0.58) 75%, rgba(196,140,33,0.44) 80%, rgba(196,140,33,0.30) 85%, rgba(196,140,33,0.16) 90%, rgba(196,140,33,0.07) 95%, rgba(196,140,33,0.00) 100%)",
                }}
              />
