          ...
          <div className="w-full flex justify-center mb-10 pt-4">
            <div className="relative w-full h-12 flex items-center justify-center">
              ...
              <div
                ...
                style={{
                  background:
                    "linear-gradient(90deg, rgba(184,134,11,0.00) 0%, rgba(184,134,11,0.20) 10%, rgba(184,134,11,0.40) 20%, rgba(184,134,11,0.70) 30%, rgba(184,134,11,1) 40%, rgba(184,134,11,1) 60%, rgba(184,134,11,0.70) 70%, rgba(184,134,11,0.40) 80%, rgba(184,134,11,0.20) 90%, rgba(184,134,11,0.00) 100%)",
                }}
              />
