          ...
          <div className="w-full flex justify-center mb-10 pt-4">
            <div className="relative w-full h-12 flex items-center justify-center">
              ...
              <div
                ...
                style={{
                  background:
                    "linear-gradient(90deg, rgba(184,134,11,0.00) 0%, rgba(184,134,11,0.07) 5%, rgba(184,134,11,0.16) 10%, rgba(184,134,11,0.3) 15%, rgba(184,134,11,0.44) 20%, rgba(184,134,11,0.58) 25%, rgba(184,134,11,0.72) 30%, rgba(184,134,11,0.86) 35%, rgba(184,134,11,1) 40%, rgba(184,134,11,1) 60%, rgba(184,134,11,0.86) 65%, rgba(184,134,11,0.72) 70%, rgba(184,134,11,0.58) 75%, rgba(184,134,11,0.44) 80%, rgba(184,134,11,0.30) 85%, rgba(184,134,11,0.16) 90%, rgba(184,134,11,0.07) 95%, rgba(184,134,11,0.00) 100%)",
                }}
              />
